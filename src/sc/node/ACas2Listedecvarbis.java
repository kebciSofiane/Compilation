...
public final class ACas2Listedecvarbis extends PListedecvarbis
{
    ...
    public Object clone()
    {
        return new ACas2Listedecvarbis(
    ...
    {
        ((Analysis) sw).caseACas2Listedecvarbis(this);
    }
