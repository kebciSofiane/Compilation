...
public final class AListexpbisListeexpbis extends PListeexpbis
{
    private TVirgule _virgule_;
    private PExp _exp_;
    private PListeexpbis _listeexpbis_;

    public AListexpbisListeexpbis()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListexpbisListeexpbis(
    ...
    {
        ((Analysis) sw).caseAListexpbisListeexpbis(this);
    }
