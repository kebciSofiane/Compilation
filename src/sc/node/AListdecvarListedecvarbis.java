...
public final class AListdecvarListedecvarbis extends PListedecvarbis
{
    private TVirgule _virgule_;
    private PDecvar _decvar_;
    private PListedecvarbis _listedecvarbis_;

    public AListdecvarListedecvarbis()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListdecvarListedecvarbis(
    ...
    {
        ((Analysis) sw).caseAListdecvarListedecvarbis(this);
    }
